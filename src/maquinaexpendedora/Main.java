...
public class Main {
    ...
    public static void main(String[] args) {
        // TODO code application logic here
              MaquinaExpendedoraRomeroMartinezElena2223 snack;
       
       
        snack=new MaquinaExpendedoraRomeroMartinezElena2223(13,2,5);
    ...
    private static void obtener3_UnidadesRomeroMartinezElena2223(MaquinaExpendedoraRomeroMartinezElena2223 snack) {
    ...
    private static void obtener2_UnidadesRomeroMartinezElena2223(MaquinaExpendedoraRomeroMartinezElena2223 snack) {
    ...
    private static void obtener1_UnidadesRomeroMartinezElena2223(MaquinaExpendedoraRomeroMartinezElena2223 snack) {
    ...
    private static void sube2_PrecioRomeroMartinezElena2223(MaquinaExpendedoraRomeroMartinezElena2223 snack) {
    ...
    private static void sube1_PrecioRomeroMartinezElena2223(MaquinaExpendedoraRomeroMartinezElena2223 snack) {
